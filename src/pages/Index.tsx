          ...
          <div className="grid items-center gap-10 grid-cols-1 lg:grid-cols-2">
            <div>
              ...
              <p className="mb-6 text-lg text-gray-700">
                At VEEP, we believe in empowering drivers with premium 6-seater vehicles that maximize your earning potential while providing comfort for you and your family. Our fleet of Toyota Noah Hybrid, Honda STEPWGN Spada, Honda Stepwagon Air vehicles are perfect for ride-sharing, family use, and more.
              </p>
              <p className="mb-6 text-lg text-gray-700">
